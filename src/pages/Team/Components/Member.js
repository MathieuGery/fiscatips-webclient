          ...
          <div className="space-y-2">
            ...
            <ul className="flex justify-center space-x-5">
              ...
              {props.person.linkedin !== null ?
                <li>
                  <a href={props.person.linkedin} className="text-gray-400 hover:text-gray-500">
              ...
              {props.person.email !== null ?
                <li>
                  <a href={"mailto:" + props.person.mail} className="text-gray-400 hover:text-gray-500">
